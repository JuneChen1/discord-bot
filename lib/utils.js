...
function toMinutes(hhmm) {
  if (!isValidDateTimeStr(hhmm, TIME_REGEX, TIME_FORMAT)) return NaN;
...
function parseRemindTime(
  ...
  if (!isValidDateTimeStr(timeStr, TIME_REGEX, TIME_FORMAT)) return null;
...
function validateDateTimeFormat(dateStr, timeStr = '') {
  ...
  if (timeStr && !isValidDateTimeStr(timeStr, TIME_REGEX, TIME_FORMAT)) {
